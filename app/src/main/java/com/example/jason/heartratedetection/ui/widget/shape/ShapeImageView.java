...
public class ShapeImageView extends ImageView implements View.OnClickListener {
    ...
    public ShapeImageView(Context context, @Nullable AttributeSet attrs) {
        ...
        shapeHelper.solid = array.getColor(R.styleable.ShapeView_sv_solid, Color.TRANSPARENT);
    ...
    public void setCheckListener(OnCheckListener mCheckListener) {
